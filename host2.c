...
/**
 * cd_dot - Changes the current working directory based on ".".
...
/**
 * cd_previous - Changes the curr working directory to the prev directory.
 * @datash: Pointer to the data_shell structure.
 * Return: None.
 */
...
/**
 * cd_to_home - Changes the current directory.
 * @datash: Pointer to the data_shell structure.
 * Return: None.
 */
